/*
Implemente uma funcao que retorne a quantidade de elementos nao nulos de uma matriz esparsa.
Input Format:
A primeira linha contem os numeros de linhas e de colunas. Em seguida, uma matriz deve ser lida.
Por ultimo, a matriz bidimensional deve ser convertida para uma matriz esparsa.

Output Format:
Impressao da quantidade de elementos nao nulos.
*/
